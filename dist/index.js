...
var usePreventScroll_1 = __importDefault(
  require('./lib/hooks/usePreventScroll')
);
...
var SlideUpTransition = function (_a) {
  var isVisible = _a.isVisible,
    ...
    onClose = _a.onClose,
    velocityClose = _a.velocityClose,
    _b = _a.unmountOnExit,
    ...
    _e = _a.hideScrollbars,
    hideScrollbars = _e === void 0 ? false : _e,
    _f = _a.className,
  ...
  var swipeHandlers = (0, react_swipeable_1.useSwipeable)({
    onSwipedDown: (0, lodash_debounce_1.default)(
      function (_a) {
        ...
        return React.createElement(
          ...
          React.createElement('div', {
            ...
            className: (0, clsx_1.default)(
              className && ''.concat(className, '__backdrop'),
              classNames.backdrop
            ),
            style: styles_1.BackdropStyles[state],
          }),
          React.createElement(
            'div',
            {
              className: (0, clsx_1.default)(className, classNames.drawer),
              style: __assign(
                __assign({}, styles_1.TransitionStyles[state]),
                getTransforms()
              ),
            },
            React.createElement(
              'div',
              __assign({}, swipeHandlers, {
                className: (0, clsx_1.default)(
                  className && ''.concat(className, '__handle-wrapper'),
