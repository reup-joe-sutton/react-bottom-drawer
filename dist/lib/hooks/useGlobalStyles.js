...
function useGlobalStyles(duration, hideScrollbars) {
    ...
    var classNames = react_1.default.useMemo(function () { return (0, styles_1.getClassNames)(identifier); }, [identifier]);
    react_1.default.useEffect(function () {
        if (typeof document === "undefined") {
            return;
        }
        var styles = (0, styles_1.default)(identifier, { duration: duration, hideScrollbars: hideScrollbars });
        var tag = document.createElement("style");
        tag.setAttribute("data-react-bottom-drawer", identifier);
        tag.innerHTML = styles;
        document.head.appendChild(tag);
        return function () {
            var stylesheet = document.querySelector("style[data-react-bottom-drawer='".concat(identifier, "']"));
            if (stylesheet) {
                stylesheet.remove();
            }
        };
